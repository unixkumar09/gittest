...
namespace Vans_SRMS_API.Migrations
{
    ...
    [Migration("20170516200340_OptionalOrderIdOnPick")]
    partial class OptionalOrderIdOnPick
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Vans_SRMS_API.Models.ItemMasterImportLog", b =>
                {
                    b.Property<int>("ItemMasterImportLogId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn);

                    b.Property<DateTime>("FileLastModifiedDate");

                    b.Property<DateTime>("FinishedAt");

                    b.Property<int>("ProductsFailedToImport");

                    b.Property<int>("ProductsImported");

                    b.Property<int>("RecordsInFile");

                    b.Property<DateTime>("StartedAt")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValueSql("now()");

                    b.HasKey("ItemMasterImportLogId");

                    b.ToTable("ItemMasterImports");
                });
            ...
            modelBuilder.Entity("Vans_SRMS_API.Models.Order", b =>
                {
                    ...
                    b.Property<int?>("PickedProductId");
            ...
            modelBuilder.Entity("Vans_SRMS_API.Models.Order", b =>
                {
                    ...
                    b.HasOne("Vans_SRMS_API.Models.Product", "PickedProduct")
                        .WithMany()
                        .HasForeignKey("PickedProductId");
